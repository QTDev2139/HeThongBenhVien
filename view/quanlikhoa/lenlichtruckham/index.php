...
$buoi ='';// giá trị buổi
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <h1 class="text-2xl font-bold">LỊCH DÀNH CHO BÁC SĨ</h1>
        ...
        <div id="scheduleForm" class="hidden mt-4 bg-white p-4 rounded shadow">
            ...
            <form id="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label for="employee" class="block text-sm font-medium text-gray-700">Bác sĩ</label>
                ...
                <div class="flex justify-end">
                    <button name="luu" type="button" id="saveSchedule" class="bg-blue-500 text-white px-4 py-2 rounded">Xem<br></button><br>
